      ...
      <div className="md:container md:mx-auto px-4 flex justify-center items-center h-screen">
        <Card className="lg:w-7/12 md:w-screen">
          <CardHeader>
            ...
            <CardDescription>
              Silahkan Register terlebih dahulu agar kamu bisa chatan dengan
              selingkuhanmu yaa...
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form>
              <div className="flex gap-2 flex-col mb-2">
                ...
                <input
                  ...
                  name="username"
                  className="border border-slate-400 px-2 py-2 rounded-md"
                />
              </div>
              <div className="flex gap-2 flex-col mb-2">
              ...
              <p className="text-slate-700">
                ...
                <Link
                  href={"/login"}
                  className="text-rose-900 hover:font-bold hover:text-blue-800 hover:underline"
                >
                  {" "}
                  Login.
                </Link>
