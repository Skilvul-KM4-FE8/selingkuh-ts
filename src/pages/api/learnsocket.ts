...
export default async function learnSocket(req: NextApiRequest, res: NextApiResponse) {
        ...
        io.on("connection", (socket: Socket) => {
            console.log("A user connected Learn")
            console.log("User Konek ke backend Learn")
